...
try {
    ...
    if ($result) {
        ...
        $link = "<a href='http://192.168.1.9:2818/reset-password?email="
            . $email . "&token=" . $token . "'>Click to reset password</a>";
        $mail = new PHPMailer();
        $mail->CharSet = "utf-8";
        $mail->isSMTP();
        $mail->SMTPAuth = true;
        $mail->Username = "vuminhloc04082003";
        $mail->Password = "xdpiuivxrozokvmj";
        $mail->SMTPSecure = "ssl";
        $mail->Host = "ssl://smtp.gmail.com";
        $mail->Port = "465";
        $mail->From = "vuminhloc04082003@gmail.com";
        $mail->FromName = "Vũ Minh Lộc";
